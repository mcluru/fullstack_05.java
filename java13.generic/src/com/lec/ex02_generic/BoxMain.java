...
public class BoxMain {
	...
	public static void main(String[] args) {
		...
		// 제네릭은 컴파일단계에서부터 에러발생을 방지할 수 있다.
		// 객체저장시에 사전에 특정 객체만 주입이 되도록 제한하는 방법이다
//		과일상자.setObject(new Hammer());	//Error
		
		// 주의사항
		// 좌변에만 제네릭을 정의하면 사전에 에러방지할 수 있지만
		...
		Box 과일상자4 = new Box<Apple>();	//제네릭으로 제한불가
...
//		도구상자.setObject(new Apple());	//Error
