...
/*
	...
	PrintStream과 PrintWriter에는 print(), println()메서드 이외 printf()메서드가 있다.
	형식화된 문자열을 출력할 수 있도록 Java8에 추가된 메서드다
	
	
	형식화문자열
	
	1. 정수 	: %d(정수, 123), %6d(6자리 정수 왼쪽은 공백 ___123), %-6d(오른쪽공백 123___), %06d(000123)
...
public class PrintFormatMain {
	...
	public static void main(String[] args) {
		...
		// 2. 실수
		System.out.printf("반지금이 %d인 원의 넓이는 %10.2f 입니다", 10, Math.PI*10*10);
		System.out.println();
