...
public class ConnectionFactory {
	...
	private void setUp() throws Exception {
		...
		// 1. DB접속정보
		DRV = p.getProperty("jdbc.mariadb.drv");	//getProperty(String key) key값을 제공하면 해당하는 Value를 문자열로 반환
		URL = p.getProperty("jdbc.mariadb.url");	//즉 path파일에서 jdbc.url을 키로, 해당하는 내용을 변수에 담음
